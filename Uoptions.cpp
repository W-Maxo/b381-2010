...
*/
  ...
  if (Form1->MyFormat.DecimalSeparator==(Char)(44)) {
...
void __fastcall TFOptions::ButtonOKClick(TObject *Sender)
{
  if (RzRadioButton2->Checked) {
	Form1->RzRegIniFile1->WriteBool("All", "DecimalSeparator", true);
	Form1->MyFormat.DecimalSeparator=(Char)(44);
  }
  else
  {
	Form1->RzRegIniFile1->WriteBool("All", "DecimalSeparator", false);
    Form1->MyFormat.DecimalSeparator=(Char)(46);
  }
}
//---------------------------------------------------------------------------
